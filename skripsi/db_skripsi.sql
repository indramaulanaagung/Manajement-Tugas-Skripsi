...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 17 Sep 2022 pada 11.28
...
--
-- Struktur dari tabel `tbl_judul_acc`
--
...
--
-- Dumping data untuk tabel `tbl_judul_acc`
--
...
--
-- Dumping data untuk tabel `tbl_skripsi`
--
...
--
-- Indeks untuk tabel `tbl_judul_acc`
--
...
--
-- Indeks untuk tabel `tbl_proposal`
--
...
--
-- AUTO_INCREMENT untuk tabel `tbl_judul`
--
ALTER TABLE `tbl_judul`
  MODIFY `id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT untuk tabel `tbl_judul_acc`
--
ALTER TABLE `tbl_judul_acc`
...
--
-- AUTO_INCREMENT untuk tabel `tbl_proposal`
--
ALTER TABLE `tbl_proposal`
